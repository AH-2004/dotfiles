;;; vertigo-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Jump down a number of lines using the home row keys." t nil)

(autoload 'vertigo-jump-up "vertigo" "\
Jump up a number of lines using the home row keys." t nil)

(autoload 'vertigo-visible-jump-down "vertigo" "\
Jump down a number of visible lines using the home row keys." t nil)

(autoload 'vertigo-visible-jump-up "vertigo" "\
Jump up a number of visible lines using the home row keys." t nil)

(autoload 'vertigo-visual-jump-down "vertigo" "\
Jump down a number of visual lines using the home row keys." t nil)

(autoload 'vertigo-visual-jump-up "vertigo" "\
Jump up a number of visual lines using the home row keys." t nil)
