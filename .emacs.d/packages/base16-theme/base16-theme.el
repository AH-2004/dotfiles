...
;;;; neotree
	 (neo-dir-link-face                            :foreground base0D)
...
;;;; diff-mode
     ...
     (diff-file-header                             :background unspecified)
     (diff-hunk-header                             :foreground base0E :background unspecified)
	 (diff-refine-added                            :background unspecified)
	 (diff-refine-changed                          :background unspecified)
	 (diff-refine-removed                          :background unspecified)
